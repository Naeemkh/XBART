XBART.multinomial <- function(y, num_class, X, Xtest, num_trees, num_sweeps, max_depth = 250, Nmin = 1, num_cutpoints = 100, alpha = 0.95, beta = 1.25, tau_a = 1, tau_b = 1, no_split_penality = NULL, weight = NULL, burnin = 1L, mtry = NULL, p_categorical = 0L, kap = 16, s = 4, verbose = FALSE, random_seed = NULL, sample_weights_flag = TRUE, sample_per_tree = FALSE, stop_threshold = 0.0, nthread = 0, ...) {
    ...
    obj = XBART_multinomial_cpp(y, num_class, X, Xtest, num_trees, num_sweeps, max_depth, Nmin, num_cutpoints, alpha, beta, tau_a, tau_b, no_split_penality, weight, burnin, mtry, p_categorical, kap, s, verbose, set_random_seed, random_seed, sample_weights_flag, sample_per_tree, stop_threshold, nthread)
